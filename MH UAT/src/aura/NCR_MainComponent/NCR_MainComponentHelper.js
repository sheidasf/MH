({
    ...
    validateContactV2: function(component, ct, perm, ctnumber, errors) {        
        ...
        //else 
           // errors[errors.length] = 'You must select a designation for all contacts.\n'; 
    ...
    validateV2 : function(component) {    
        ...
        // future: if (hcpcount == 0) {
       //      errors[errors.length] = 'You must have at least one hcp.\n'; 
