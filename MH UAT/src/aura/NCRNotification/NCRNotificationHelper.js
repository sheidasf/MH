({
    validate : function (component, event) {
        ...
        if (!component.find("regFaxNumberId").get("v.validity").valid)
        {
            errors[errors.length] = 'Invalid registration fax number. Fax number should be 10 digits or (###) ###-####.\n';            
        }
        if (!component.find("resFaxNumberId").get("v.validity").valid)
        {
            errors[errors.length] = 'Invalid results fax number. Fax number should be 10 digits or (###) ###-####.\n';            
        }      
